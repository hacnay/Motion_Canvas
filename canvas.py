...
class Canvas():
    ...
    def __init__(self, columns, rows):
        self.colors = {
                ...
                "Black": (0,0,0),
                "Purple": (271,92,98),
                "Random": (random.randint(0,255),random.randint(0,255),0),
    ...
    def draw_dashboard(self, frame, gesture = "HOVER", data = {}):
        ...
        # add clear_button
        clear_button_width = int(frame_width *.1) # clear button always takes 20% of screen space
        clear_button_height = int(frame_height * .1) # all button take up 15% of screen height
